...
@Table(name = "part_listing_threads")
class PartListingThreadEntity(
    @Id
    @Column("id")
...
@Table(name = "part_listing_messages")
class PartListingMessageEntity(
    @Id
    @Column("id")
...
@Table(name = "part_listing_message_attachments")
class PartListingMessageAttachmentEntity(
    @Id
    @Column("id")
