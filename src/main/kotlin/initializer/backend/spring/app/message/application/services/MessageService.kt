package initializer.backend.spring.app.message.application.services
...
import initializer.backend.spring.app.message.domain.models.request.PlatformReplyRequest
import initializer.backend.spring.app.message.domain.models.request.SupportMessageRequest
import initializer.backend.spring.app.message.domain.models.request.SupportThreadRequest
import initializer.backend.spring.app.message.infrastructure.mapper.toDomain
import initializer.backend.spring.app.message.infrastructure.mapper.toEntity
import initializer.backend.spring.app.message.infrastructure.repositories.MessageRepository
import initializer.backend.spring.app.message.infrastructure.repositories.SupportThreadRepository
